...
TEST_CASE("DH::testRemoveEASY", "[weight=6]")
{
...
TEST_CASE("DH::testRemoveHard", "[weight=10]")
{
...
TEST_CASE("DH::testResizeOnce", "[weight=7]" )
{
...
TEST_CASE("DH::testResizeAll", "[weight=11]")
{
...
TEST_CASE("DH::testInsertEasy", "[weight=6]")
{
	TextFile infile( "tests/textEasy.txt" );
	DHHashTable<string, int> hashTable(32);
	int val = 0;
...
TEST_CASE("DH::testInsertHard", "[weight=10]")
{
	TextFile infile( "tests/textHard.txt" );
	DHHashTable<string, int> hashTable(32);
    int val = 0;
